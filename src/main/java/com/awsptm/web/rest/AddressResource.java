...
import com.awsptm.service.AddressQueryService;
import com.awsptm.service.AddressService;
...
/**
 * REST controller for managing {@link com.awsptm.domain.Address}.
 */
@RestController
@RequestMapping("/api")
public class AddressResource {
    ...
    public ResponseEntity<AddressDTO> createAddress(@RequestBody AddressDTO addressDTO) throws URISyntaxException {
        ...
        if (Objects.isNull(addressDTO.getGoogleAddress())) {
