...
/**
 * Criteria class for the {@link com.awsptm.domain.Inspection} entity. This class is used
 * in {@link com.awsptm.web.rest.InspectionResource} to receive all the possible filtering options from
...
public class InspectionCriteria implements Serializable, Criteria {
    ...
    private DurationFilter frequency;
    ...
    public DurationFilter getFrequency() {
        return frequency;
    }

    public DurationFilter frequency() {
        if (frequency == null) {
            frequency = new DurationFilter();
        }
        return frequency;
    }

    public void setFrequency(DurationFilter frequency) {
