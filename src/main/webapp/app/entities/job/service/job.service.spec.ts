...
describe('Job Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      created: currentDate,
      occupiersName: 'AAAAAAA',
      occupiersHomePhone: 'AAAAAAA',
      occupiersWorkPhone: 'AAAAAAA',
      occupiersMobilePhone: 'AAAAAAA',
      clientOrderId: 'AAAAAAA',
      assignedAt: currentDate,
      scheduled: currentDate,
      completed: currentDate,
      invoiceNumber: 'AAAAAAA',
      fault: 'AAAAAAA',
      accessInstructions: 'AAAAAAA',
      updated: currentDate,
    };
  });
  ...
  describe('Service methods', () => {
    ...
    describe('addJobToCollectionIfMissing', () => {
      ...
      it('should add only unique Job to an array', () => {
        const jobArray: IJob[] = [{ id: 123 }, { id: 456 }, { id: 5420 }];
