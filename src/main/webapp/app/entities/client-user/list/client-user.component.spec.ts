...
describe('ClientUser Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'client-user', component: ClientUserComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.clientUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
