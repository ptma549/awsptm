...
export class ClientUserComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.clientUserService
      ...
      .subscribe({
        next: (res: HttpResponse<IClientUser[]>) => {
  ...
  trackId(index: number, item: IClientUser): number {
    return item.id!;
  }

  delete(clientUser: IClientUser): void {
    const modalRef = this.modalService.open(ClientUserDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IClientUser[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
