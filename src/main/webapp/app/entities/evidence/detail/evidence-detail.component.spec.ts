...
describe('Evidence Management Detail Component', () => {
  let comp: EvidenceDetailComponent;
      ...
      providers: [
        {
          ...
          useValue: { data: of({ evidence: { id: 123 } }) },
        },
      ],
    })
      .overrideTemplate(EvidenceDetailComponent, '')
      .compileComponents();
  ...
  describe('OnInit', () => {
    it('Should load evidence on init', () => {
      // WHEN
      comp.ngOnInit();

      // THEN
      expect(comp.evidence).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
