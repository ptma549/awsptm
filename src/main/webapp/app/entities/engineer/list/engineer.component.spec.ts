...
describe('Engineer Management Component', () => {
  let comp: EngineerComponent;
  let fixture: ComponentFixture<EngineerComponent>;
  let service: EngineerService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'engineer', component: EngineerComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(EngineerComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.engineers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
