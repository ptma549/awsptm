...
describe('GoogleAddress Management Component', () => {
  let comp: GoogleAddressComponent;
  let fixture: ComponentFixture<GoogleAddressComponent>;
  let service: GoogleAddressService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'google-address', component: GoogleAddressComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(GoogleAddressComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.googleAddresses?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
