...
describe('AddressComponent Management Component', () => {
  let comp: AddressComponentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'address-component', component: AddressComponentComponent }]),
      ...
      .overrideTemplate(AddressComponentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.addressComponents?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
